...
player_images = []
for i in range(1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'папка пнг/pacman.png'), (45, 45)))
blinky_img = pygame.transform.scale(pygame.image.load(f'папка пнг/Blinky.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'папка пнг/Pinky.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'папка пнг/Inky.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'папка пнг/Clyde.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'папка пнг/powerup.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'папка пнг/dead.png'), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
